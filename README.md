...
<UL><FONT style="FONT-SIZE: 10pt" face=Arial color=#000000>
 ...
 <LI><B>Disable Registry Editing Tools</B>
 <UL>
 <LI><B>Location</B><BR>HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Policies\System\<FONT
 color=#c00000>DisableRegistryTools</FONT>
 <LI><B>Data Type</B><BR><B>DWORD</B> (set value of 0x00000001)</LI></UL><BR>
